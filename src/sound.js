...
const doorOpen = new Audio(
  jsfxr([
    1, 0.361, 0.01, , 0.3835, 0.8165, 0.472, -0.3, -0.0109, , , , , 0.1925, 0.111, , -0.0109, 0.056, 1, , , , , 0.5
  ])
)
const doorClose = new Audio(
  jsfxr([
    1, 0.228, 0.01, , 0.1835, 0.428, 0.3835, 0.189, -0.0109, , , , , 0.1925, 0.111, , 0.0329, 0.056, 0.539, , 0.272, 0.1055, -0.4329, 0.5
  ])
)
